...
namespace ElectDisciplinesAPI.Migrations
{
    ...
    [Migration("20231210193322_AddDisciplineNumberToDb")]
    partial class AddDisciplineNumberToDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ElectDisciplines_API.Models.Discipline", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Course = 2,
                            CreatedDate = new DateTime(2023, 12, 10, 21, 33, 22, 764, DateTimeKind.Local).AddTicks(7998),
                            Description = "",
                        ...
                        new
                        {
                            Id = 2,
                            Course = 2,
                            CreatedDate = new DateTime(2023, 12, 10, 21, 33, 22, 764, DateTimeKind.Local).AddTicks(8044),
                        ...
                        new
                        {
                            Id = 3,
                            Course = 2,
                            CreatedDate = new DateTime(2023, 12, 10, 21, 33, 22, 764, DateTimeKind.Local).AddTicks(8047),
                        ...
                        new
                        {
                            Id = 4,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 21, 33, 22, 764, DateTimeKind.Local).AddTicks(8049),
                        ...
                        new
                        {
                            Id = 5,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 21, 33, 22, 764, DateTimeKind.Local).AddTicks(8052),
                        ...
                        new
                        {
                            Id = 6,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 21, 33, 22, 764, DateTimeKind.Local).AddTicks(8054),
                        ...
                        new
                        {
                            Id = 7,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 21, 33, 22, 764, DateTimeKind.Local).AddTicks(8057),
                        ...
                        new
                        {
                            Id = 8,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 21, 33, 22, 764, DateTimeKind.Local).AddTicks(8059),
                            Description = "",
                            ImageUrl = "https://my.kpi.ua/static/images/logo_fiot.png",
                        ...
                        new
                        {
                            Id = 9,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 21, 33, 22, 764, DateTimeKind.Local).AddTicks(8062),
                        ...
                        new
                        {
                            Id = 10,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 21, 33, 22, 764, DateTimeKind.Local).AddTicks(8064),
                            Description = "",
                            ImageUrl = "https://my.kpi.ua/static/images/logo_fiot.png",

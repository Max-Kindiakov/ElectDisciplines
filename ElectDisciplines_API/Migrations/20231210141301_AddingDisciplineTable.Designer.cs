...
namespace ElectDisciplinesAPI.Migrations
{
    ...
    [Migration("20231210141301_AddingDisciplineTable")]
    partial class AddingDisciplineTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ElectDisciplines_API.Models.Discipline", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Course = 2,
                            CreatedDate = new DateTime(2023, 12, 10, 16, 13, 1, 222, DateTimeKind.Local).AddTicks(4968),
                            Description = "",
                        ...
                        new
                        {
                            Id = 2,
                            Course = 2,
                            CreatedDate = new DateTime(2023, 12, 10, 16, 13, 1, 222, DateTimeKind.Local).AddTicks(5022),
                        ...
                        new
                        {
                            Id = 3,
                            Course = 2,
                            CreatedDate = new DateTime(2023, 12, 10, 16, 13, 1, 222, DateTimeKind.Local).AddTicks(5026),
                        ...
                        new
                        {
                            Id = 4,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 16, 13, 1, 222, DateTimeKind.Local).AddTicks(5030),
                        ...
                        new
                        {
                            Id = 5,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 16, 13, 1, 222, DateTimeKind.Local).AddTicks(5034),
                        ...
                        new
                        {
                            Id = 6,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 16, 13, 1, 222, DateTimeKind.Local).AddTicks(5038),
                        ...
                        new
                        {
                            Id = 7,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 16, 13, 1, 222, DateTimeKind.Local).AddTicks(5042),
                        ...
                        new
                        {
                            Id = 8,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 16, 13, 1, 222, DateTimeKind.Local).AddTicks(5046),
                            Description = "",
                            ImageUrl = "https://my.kpi.ua/static/images/logo_fiot.png",
                        ...
                        new
                        {
                            Id = 9,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 16, 13, 1, 222, DateTimeKind.Local).AddTicks(5051),
                        ...
                        new
                        {
                            Id = 10,
                            Course = 3,
                            CreatedDate = new DateTime(2023, 12, 10, 16, 13, 1, 222, DateTimeKind.Local).AddTicks(5055),
                            Description = "",
                            ImageUrl = "https://my.kpi.ua/static/images/logo_fiot.png",
